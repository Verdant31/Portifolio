...
export const Experience = ({ experiences }: ExperienceProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex space-x-5 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-green-500/80 overflow-x-scroll mt-24 xl:pt-24  snap-x snap-mandatory justify-start">
